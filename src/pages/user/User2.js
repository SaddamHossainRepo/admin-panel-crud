...
var User = function User() {
  ...
  var tokenString = localStorage.getItem("user-info");
  var token = JSON.parse(tokenString !== null && tokenString !== void 0 ? tokenString : "");
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("http://localhost:9000/v1/users/me", {
                method: "GET",
